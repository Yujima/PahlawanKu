...
public class AdapterCard extends RecyclerView.Adapter<AdapterCard.VeiwHolder> {
    ...
    @NonNull
    @Override
    public AdapterCard.VeiwHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card, parent, false);
        return new VeiwHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterCard.VeiwHolder holder, int position) {
